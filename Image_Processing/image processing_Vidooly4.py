...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 19 20:41:34 2018
...
# It opens the folder where your test images a stored and then tests them.
...
for file in os.listdir("test/"):   # Look into the given path
    if file.endswith(".jpg"):	   # Look for files with .jpg as extension
        print (str(file)) 
        subprocess.call(['python','test_core.py' ,str(path+file)], shell=True)